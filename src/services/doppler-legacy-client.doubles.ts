...
export class HardcodedDopplerLegacyClient implements DopplerLegacyClient {
  ...
  public async getAllPlans(): Promise<any[]> {
    ...
    return [
      ...
      { type: 'prepaid', id: 5, name: '15000-CREDITS', credits: 15000, price: 185 },
      { type: 'prepaid', id: 6, name: '25000-CREDITS', credits: 25000, price: 250 },
      { type: 'prepaid', id: 7, name: '50000-CREDITS', credits: 50000, price: 400 },
      { type: 'prepaid', id: 8, name: '100000-CREDITS', credits: 100000, price: 600 },
      {
